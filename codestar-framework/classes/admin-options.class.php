...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'AiYa-CMS <small> |´・ω・)ノ </small>',
      'framework_class'         => '',
      ...
      // footer
      'footer_text'             => 'By <a href="https://www.yeraph.com" target="_blank" style="text-decoration:none">Yeraph Studio</a>', // Thank you for creating with Codestar Framework
      'footer_after'            => '',
      'footer_credit'           => '',
