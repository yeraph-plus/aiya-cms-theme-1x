...
if( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'AiYa-CMS <small>By <a href="https://www.yeraph.com" target="_blank" style="text-decoration:none">Yeraph Studio</a></small>',
      'framework_class'         => '',
    ...
    public function add_admin_footer_text() {
      $default = '<span id="footer-thankyou">本页面由 CodeStar-Framework 创建。</span>';
