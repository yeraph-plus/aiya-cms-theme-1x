...
class Aya_Hot_Posts extends WP_Widget {

    //小工具信息
    function __construct() {
        $widget_options = array (
            'classname' => 'widget-post-box',
            'description' => '展示30天内点击最高的文章'
        );
        parent::__construct( 'hot_posts', 'AiYa-CMS-热门文章' , $widget_options);
    }
        ...
        if($the_query->have_posts()){
            ...
            echo '<li>
                    ...
                    <div class="loop">
                        ...
                        <p><i class="bi bi-eye"></i>&nbsp;'.get_post_views().'人浏览</p>
                    </div>
                </li>';
            endwhile;
            ...
            echo '<ul><li class="post-link">没有热门文章</li></ul>';
        }
        echo '</div>';
        echo $after_widget;
    }
