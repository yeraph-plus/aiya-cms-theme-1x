            ...
            <div class="carousel-item <?php if ( $i == '0') { echo 'active'; } ?>">
                <a class="banlist" href="<?php the_permalink(); ?>">
                    ...
                    if ( has_post_thumbnail() ) {
                        ...
                        echo wp_get_attachment_image(get_theme_mod('aya_nopic'), array(700, 400, true));
                    }
                    ?>
                    <h2><?php the_title(); ?></h2>
                    <i>置顶精彩</i>
    ...
    <div class="index_banner_center">
        ...
        <a class="zt_list" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
            ...
            if ( has_post_thumbnail() ) {
                ...
                echo wp_get_attachment_image(get_theme_mod('aya_nopic'), array(300, 300, true));
            }
            ?>
            <h3><?php the_title(); ?></h3>
...
<div class="col-lg-3 none_992">
    ...
    <a class="gglb" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
        ...
        if ( has_post_thumbnail() ) {
            ...
            echo wp_get_attachment_image(get_theme_mod('aya_nopic'), array(300, 400, true));
        }
        ?>
        <div class="gg_txt">
            <h3><?php the_title(); ?></h3>
